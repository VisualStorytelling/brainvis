...
var ProvenanceSlidesComponent = /** @class */ (function () {
    ...
    ProvenanceSlidesComponent.prototype.addSlide = function () {
        var node = this._deck.graph.current;
        var slide = new _visualstorytelling_provenance_core__WEBPACK_IMPORTED_MODULE_1__["ProvenanceSlide"](node.label, 5000, 0, [], node);
        this._deck.addSlide(slide, this._deck.selectedSlide
